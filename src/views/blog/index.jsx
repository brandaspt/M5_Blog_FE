        ...
        <div className="blog-details-root">
          <Container>
            ...
            <div className="d-flex justify-content-start mb-3">
              <Button as={Link} to={`/blog/${this.state.blog._id}/edit`} variant="dark" className="btn-sm">
                Edit
              </Button>
              <Button variant="danger" className="btn-sm mx-2" onClick={this.handleDelete}>
                Delete
              </Button>
              <Button variant="info" href={`${BACKEND_URL}/blogPosts/${this.state.blog._id}/downloadPDF`} className="btn-sm" as="a">
                Download PDF
              </Button>
            </div>
